...
fn setup_world(mut commands: Commands) {
    ...
    // Platform
    spawn_wall(&mut commands, Vec3::new(WORLD_LEFT + WORLD_WIDTH/4.0, WORLD_BOTTOM + WORLD_HEIGHT/4.0, 0.0), Vec3::new(150.0, BORDER_WIDTH, 0.0));
    spawn_wall(&mut commands, Vec3::new(WORLD_WIDTH_MIDDLE, WORLD_BOTTOM + WORLD_HEIGHT/2.0, 0.0), Vec3::new(150.0, BORDER_WIDTH, 0.0));
